...
~~~
    # Example: training ALGCN on NTU RGB+D cross subject with GPU 0
...
~~~
    # Example: training ALGCN on NTU RGB+D 120 cross subject under bone modality
    python main.py --config config/nturgbd120-cross-subject/default.yaml --train_feeder_args bone=True --test_feeder_args bone=True --work-     dir work_dir/ntu120/csub/algcn_bone --device 0
~~~
...
~~~
    python main.py --config config/ucla/default.yaml --work-dir work_dir/ucla/algcn_xxx --device 0
~~~
...
~~~
    python main.py --config config/uav/default.yaml --work-dir work_dir/uav/algcn_xxx --device 0
~~~
...
~~~
    # Example: ensemble four modalities of ALGCN on NTU RGB+D cross subject
